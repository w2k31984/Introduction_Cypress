...
class TestResultsData {
    /** @internal */
    constructor(results, deleteTest) {
        this._results = {};
    ...
    /** @deprecated */
    setHostDisplaySize(hostDisplaySize) {
    ...
    /** @deprecated */
    setLayoutMatches(layoutMatches) {
    ...
    isPassed() {
        return this._results.status === TestResultsStatus_1.TestResultsStatusEnum.Passed;
    }
    async delete() {
        if (!this._deleteTest)
            return;

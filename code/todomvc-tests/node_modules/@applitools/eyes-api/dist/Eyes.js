...
class Eyes {
    ...
    async check(checkSettingsOrName, checkSettings) {
        ...
        (_a = settings.fully) !== null && _a !== void 0 ? _a : (settings.fully = false);
    ...
    async abort() {
        ...
        return this._eyes
            ...
            return new TestResults_1.TestResultsData(result, settings => this._spec.deleteTest({
                settings: Object.assign(Object.assign({}, settings), { serverUrl: this._config.serverUrl, apiKey: this._config.apiKey, proxy: this._config.proxy }),
            }));
        })

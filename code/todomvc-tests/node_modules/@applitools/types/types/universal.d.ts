...
export declare type ClientSocket<TDriver, TContext, TElement, TSelector> = unknown & Request<Omit<Core<TDriver, TElement, TSelector>, 'isDriver' | 'isElement' | 'isSelector'>, 'Core'> & Request<EyesManager<TDriver, TElement, TSelector>, 'EyesManager', 'manager'> & Request<Eyes<TElement, TSelector>, 'Eyes', 'eyes'> & Request<Server, 'Server'> & Request<Debug<TDriver, TContext, TElement, TSelector>, 'Debug'> & Command<UniversalSpecDriver<TDriver, TContext, TElement, TSelector>, 'Driver'>;
export declare type ServerSocket<TDriver, TContext, TElement, TSelector> = unknown & Command<Omit<Core<TDriver, TElement, TSelector>, 'isDriver' | 'isElement' | 'isSelector'>, 'Core'> & Command<EyesManager<TDriver, TElement, TSelector>, 'EyesManager', 'manager'> & Command<Eyes<TElement, TSelector>, 'Eyes', 'eyes'> & Command<Server, 'Server'> & Command<Debug<TDriver, TContext, TElement, TSelector>, 'Debug'> & Request<UniversalSpecDriver<TDriver, TContext, TElement, TSelector>, 'Driver'>;
export {};

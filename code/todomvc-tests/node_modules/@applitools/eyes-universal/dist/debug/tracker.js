...
function withTracker(options) {
        ...
        return originalCommand(name, async (payload) => {
            ...
            try {
                ...
                if (name === 'Core.makeManager') {
                    ...
                    history.managers.set(extractRefId(managerRef), Object.assign(Object.assign({}, payload), { manager: result, eyes: [] }));
                }
                    ...
                    if (error) {
                        managerHistory.eyes.push(Object.assign(Object.assign({}, payload), { error }));
                    }
                    else {
                        const eyesRef = result;
                        managerHistory.eyes.push(eyesRef);
                        history.eyes.set(extractRefId(eyesRef), Object.assign(Object.assign({}, payload), { eyes: eyesRef, commands: [] }));
                    }
                }
                    ...
                    if (eyesHistory) {
                        const command = Object.assign({ name }, payload);
                        if (error)
                            command.error = error;
                        else
    ...
    socket.getHistory = function getHistory() {
        return {
            managers: Array.from(history.managers.values(), managerMeta => (Object.assign(Object.assign({}, managerMeta), { eyes: managerMeta.eyes.map(eyesRefOrError => {
